          ...
          <div className="space-y-10">
            ...
            <div>
              <div className="flex justify-between items-center mb-4">
                <label className="text-lg font-medium">Average Hourly Rate of Time Saved</label>
            ...
            <div>
              <div className="flex justify-between items-center mb-4">
                <label className="text-lg font-medium">Hours of Manual Work Eliminated Weekly</label>
                <span className="text-2xl font-bold text-primary">{hoursPerWeek} hrs</span>
              </div>
              <Slider
                value={[hoursPerWeek]}
            ...
            <div className="pt-8 border-t border-border">
              <div className="grid md:grid-cols-2 gap-6">
                <div className="text-center p-6 bg-secondary/50 rounded-xl">
                  <p className="text-muted-foreground mb-2">Weekly Savings</p>
              ...
              <p className="text-center text-sm text-muted-foreground mt-6">
                Based on {hoursPerWeek} hours/week at ${hourlyRate}/hr over 52 weeks
              </p>
            </div>
          </div>
        </motion.div>
